...
export class TourSliderComponent implements OnInit, OnDestroy {
  tours: TourItem[] = [];
  ...
  constructor(private infoTourService: infoTour, private router: Router) {}

  ngOnInit(): void {
    // Lấy dữ liệu tour từ service
    this.tours = this.infoTourService.arr2;
